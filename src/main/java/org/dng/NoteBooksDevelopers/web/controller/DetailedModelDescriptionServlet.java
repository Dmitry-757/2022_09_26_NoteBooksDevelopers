...
@WebServlet(name = "DetailedModelDescriptionServlet", value = "/DevModels/Desc")
public class DetailedModelDescriptionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        int photosNumber = DAO.getDetailedModelsPhotosByDetailedModelsId(modelId).size();
...
//        final IWebRequest webRequest = webExchange.getRequest();
        ...
        ctx.setVariable("detailedModelMap", DAO.getDetailedModelsByModelId(modelId));
        ctx.setVariable("photosNumber",photosNumber);

        templateEngine.process("DetailedModelDescription", ctx, writer);
    }
