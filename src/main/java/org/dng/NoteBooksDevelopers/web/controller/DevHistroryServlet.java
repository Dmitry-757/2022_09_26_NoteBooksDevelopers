...
@WebServlet(name = "DevHistroryServlet", value = "/DevHistrory")
public class DevHistroryServlet extends HttpServlet {
...
//        final IWebRequest webRequest = webExchange.getRequest();
        ...
        ctx.setVariable("historyMap", DAO.getDevHistoryById(devId));

        templateEngine.process("devHistory", ctx, writer);
    }
