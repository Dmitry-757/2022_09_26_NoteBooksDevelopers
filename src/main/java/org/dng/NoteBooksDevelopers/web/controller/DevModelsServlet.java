...
@WebServlet(name = "DevModelsServlet", value = "/DevModels")
public class DevModelsServlet extends HttpServlet {
...
//        final IWebRequest webRequest = webExchange.getRequest();
        ...
        ctx.setVariable("modelsMap", DAO.getDevModelsById(devId));

        templateEngine.process("devModels", ctx, writer);
    }
